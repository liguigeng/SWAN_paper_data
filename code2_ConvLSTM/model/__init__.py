...
from .e3d import E3DLSTMNet
from .MIM import MIMNet
from .trajGRU import TrajGRUNet
from .predrnnpp import PredRNNPP
from .predrnn import PredRNNNet
...
from code2_ConvLSTM.self_dataloader import p,q,EPOCH
...
class Solver(object):
    ...
    def train(self, epoch):
        ...
        for batch, data in enumerate(loader):
            ...
            # input, label =torch.unsqueeze(input, dim=2),torch.unsqueeze(label, dim=2)
            ...
            # record
            self.log.info('Epoch:[{}/{}]\t Iteration:[{}/{}]\t {}'.format(epoch, EPOCH, batch, len(loader), printStr))
